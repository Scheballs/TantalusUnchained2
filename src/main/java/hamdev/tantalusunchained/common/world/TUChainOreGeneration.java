...
@Mod.EventBusSubscriber(modid = TantalusUnchained.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class TUChainOreGeneration {
    @SubscribeEvent
    ...
    public static void addFeatureToBiome(Biome biome, GenerationStage.Decoration decoration, ConfiguredFeature<?, ?> configuredFeature) {
        ...
        /* Change field_24248_f that contains the Configured Feature of the Biome */
