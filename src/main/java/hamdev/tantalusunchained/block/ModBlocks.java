...
public class ModBlocks {
    public static final RegistryObject<Block> BLOCK_TANTALUM      = register( "block_tantalum"     ,() -> new Block(AbstractBlock.Properties.create(Material.IRON).hardnessAndResistance( 3f, 10f).sound(SoundType.METAL)));
    public static final RegistryObject<Block> ORE_TANTALUM        = register( "ore_tantalum"       ,() -> new Block(AbstractBlock.Properties.create(Material.ROCK).hardnessAndResistance( 3f, 10f).sound(SoundType.STONE)));
